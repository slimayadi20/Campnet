...
public class ReclamationForm extends BaseForm {
    ...
    public ReclamationForm(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Reclamations Back", barGroup);
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Reclamation eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), res, eyy.getDescription(),eyy.getEmail(), eyy.getId());
 ...
 Container round = new Container();
    ...
    private void addButton(Image img,Resources res, String description,String email, float id) {
        ...
        cnt.add(BorderLayout.CENTER,
                BoxLayout.encloseY(
                        ta, Description,Email
                ));
        add(cnt);
        image.addActionListener(e -> {

            UpdateReclamation a = new UpdateReclamation(res, description,email, id);
               System.out.println(id);
            a.show();
        });
    }
