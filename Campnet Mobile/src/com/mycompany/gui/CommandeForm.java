...
public class CommandeForm extends BaseForm {
    ...
    public CommandeForm(Resources res) {
        super("CommandeForm", BoxLayout.y());
        ...
        RadioButton all = RadioButton.createToggle("Mes Commande", barGroup);
        ...
        ArrayList<Commande> en = ServiceCommande.getInstance().getAllCommandes();
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Commande eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getProduit(), res, eyy.getQuantite(), eyy.getId(), eyy.getTotal(),eyy.getDate());
    ...
    private void addButton(Image img, String produit, Resources res, float quantite, float id, float total,String date) {
        ...
        TextArea ta = new TextArea(produit);
        ta.setUIID("NewsTopLine");
        ta.setEditable(false);
        
        
       
        TextArea qt = new TextArea(String.valueOf(quantite));
        qt.setUIID("NewsTopLine");
        qt.setEditable(false);

        TextArea tot = new TextArea(String.valueOf(total));
        tot.setUIID("NewsTopLine");
        tot.setEditable(false);

        TextArea da = new TextArea(date);
