...
public class CommentaireForm extends BaseForm {
    ...
    public CommentaireForm(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Commentaires Back", barGroup);
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Commentaire eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), res, eyy.getDescription(), eyy.getId());
 ...
 Container round = new Container();
        ...
        fab.addActionListener(e -> {
            new addCommentaireForm(res).show();
        });
    ...
    private void addButton(Image img,Resources res, String description, float id) {
        ...
        image.addActionListener(e -> {
            ...
            UpdateCommentaire a = new UpdateCommentaire(res, description, id);
               System.out.println(id);
            a.show();
        });
    }
