...
public class PanierForm extends BaseForm {
    ...
    public PanierForm(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Mon Panier", barGroup);
        ...
        ArrayList<Panier> en = ServicePanier.getInstance().getAllPaniers();
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Panier eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getNom(), res, eyy.getQuantite(),eyy.getPrix(), eyy.getId());
    ...
    private void addButton(Image img, String nom, Resources res, float quantite,float prix, float id) {
        ...
        Label qt = new Label("Quantité :"+quantite);
        Label pr = new Label("Prix :"+prix);
