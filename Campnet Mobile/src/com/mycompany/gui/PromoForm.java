...
public class PromoForm extends BaseForm {
    ...
    public PromoForm(Resources res) {
        super("PromoForm", BoxLayout.y());
        ...
        RadioButton all = RadioButton.createToggle("Mes Promo", barGroup);
    ...
    private void addButton(Image img, String Nom_promo, Resources res, float nv_prix, float id, String Description_promo) {
        ...
        TextArea ta = new TextArea(Nom_promo);
        ta.setUIID("NewsTopLine");
        ta.setEditable(false);
        
        
       
        TextArea Prix = new TextArea(String.valueOf(nv_prix));
        Prix.setUIID("NewsTopLine");
        Prix.setEditable(false);

        TextArea desc = new TextArea(Description_promo);
