...
public class ProduitFormBack extends BaseFormBack {
    ...
    public ProduitFormBack(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Produits Back", barGroup);
 ...
 Container round = new Container();
    ...
    private void addButton(Image img, String nom, Resources res, float prix, float id, String description, String disponibilite,String photo) {
        ...
        Label Disp = new Label("Disponibilité :"+disponibilite);
        Label Photo = new Label("Photo :"+photo);
        
        //  System.out.println(id);
        cnt.add(BorderLayout.CENTER,
                BoxLayout.encloseY(
                        ta, Nom,Prix,Desc,Disp,Photo
                ));
        add(cnt);
        image.addActionListener(e -> {

            UpdateProduitBack a = new UpdateProduitBack(res, nom, prix, description, disponibilite,photo, id);
               System.out.println(id);
            a.show();
        });
    }
