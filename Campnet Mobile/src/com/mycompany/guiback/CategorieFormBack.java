 ...
 * @author sarra
 */
public class CategorieFormBack extends BaseFormBack {

   
    public CategorieFormBack(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Categories Back", barGroup);
        ...
        ArrayList<Categorie> en = ServiceCategorie.getInstance().getAllCategories();
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Categorie eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getTheme(), res, eyy.getDescription(), eyy.getId());
 ...
 Container round = new Container();
        ...
        fab.addActionListener(e -> {
            new addCategorieFormBack(res).show();
        });
    ...
    private void addButton(Image img, String theme, Resources res, String description, float id) {
        ...
        Label Theme = new Label("Theme  :"+theme);
        ...
        cnt.add(BorderLayout.CENTER,
                BoxLayout.encloseY(
                        ta, Theme,Description
                ));
        add(cnt);
        image.addActionListener(e -> {

            UpdateCategorieBack a = new UpdateCategorieBack(res, theme, description, id);
               System.out.println(id);
            a.show();
        });
    }
