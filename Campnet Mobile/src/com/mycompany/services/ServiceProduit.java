...
public class ServiceProduit {
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setPhoto(obj.get("prix").toString());
 ...
 public boolean addProduit(Produit t) {
        ...
        String url = Statics.BASE_URL+"/addProduitMobile?nom=" + t.getNom()+"&prix="+t.getPrix()+"&description="+t.getDescription()+"&disponibilite="+t.getDisponibilite()+"&photo="+t.getPhoto(); //création de l'URL
     ...
     public void deletProduit(float id){   
        ...
        Dialog d = new Dialog();
            ...
            {             
                ...
                //System.out.println(Statics.BASE_URL+"/deleteProduitMobile?id="+id);
                NetworkManager.getInstance().addToQueueAndWait(req);
...
public boolean updateProduit(Produit t) {
        String url = Statics.BASE_URL+"/updateProduitMobile?nom=" + t.getNom()+"&prix="+t.getPrix()+"&description="+t.getDescription()+"&disponibilite="+t.getDisponibilite()+"&photo="+t.getPhoto()+"&id="+t.getId(); //création de l'URL
        System.out.println(url);
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
