...
public class ServiceReclamation {
 ...
 public boolean addReclamation(Reclamation t) {
     float id=2;
        String url = Statics.BASE_URL+"/addReclamationMobile?description="+t.getDescription()+"?email="+t.getEmail(); //création de l'URL
...
System.out.println(url);
    ...
    public boolean updateReclamation(Reclamation t) {
        String url = Statics.BASE_URL+"/updateReclamationMobile?description="+t.getDescription()+"?email="+t.getEmail()+"&id="+t.getId(); //création de l'URL
        System.out.println(url);
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
