...
import com.mycompany.guiback.NewsfeedFormBack;
...
public class ServiceUser {
    ...
    public void signup(TextField nom, TextField prenom, TextField email, TextField password, TextField confirmPassword, TextField Phone, Resources res) {
        String url = Statics.BASE_URL + "/signupMobile?email=" + email.getText().toString() + "&nom=" + nom.getText().toString() + "&prenom=" + prenom.getText().toString() + "&password=" + password.getText().toString() + "&GSM=" + Phone.getText().toString();
        req.setUrl(url);
...
//String role=(user.get("roles").getJsonObject(0)) ;
                   ...
                   // System.out.println(role.get(0));
                    ...
                    if (!user.isEmpty() && "ROLE_ADMIN".equals(role.get(0))) {
                        ...
                        float phone = Float.parseFloat(user.get("GSM").toString());
                        SessionManager.setPhone((int) phone);
...
// karim.trabelsi1@esprit.tn
    ...
    public static void EditUser(String nom, String prenom, String email, String password, String imageFile,float p) {
        String url = Statics.BASE_URL + "/editUserMobile?&email=" + email + "&password=" + password + "&nom=" + nom + "&prenom=" + prenom + "&imageFile=" + imageFile+"&GSM="+p;
