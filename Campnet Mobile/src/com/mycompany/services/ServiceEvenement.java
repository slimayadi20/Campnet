...
public class ServiceEvenement {
  ...
  public ArrayList<Evenement> parseEvenement(String jsonText){
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setLieu(obj.get("Produit").toString());
                t.setPrix((int)Prix);
    ...
    public ArrayList<Evenement> getAllEvenements(){
        ...
        String url = Statics.BASE_URL+"/displayEvenementsMobile";
        req.setUrl(url);
        req.setPost(false);
 ...
 public boolean addEvenement(Evenement t) {
        ...
        String url = Statics.BASE_URL+"/addEvenementMobile?nom=" + t.getNom()+ "&photo="+t.getPhoto()+"&description="+t.getDescription()+"&lieu="+t.getLieu()+"&prix="+t.getPrix(); //création de l'URL
...
System.out.println(url);
     ...
     public void deletEvenement(float id){   
        ...
        Dialog d = new Dialog();
            ...
            {             
                ...
                req.setUrl(Statics.BASE_URL+"/deleteEvenementMobile?id="+id);
   ...
   public boolean updateEvenement(Evenement t) {
        String url = Statics.BASE_URL+"/updateEvenementMobile?nom=" + t.getNom()+"&photo="+t.getPhoto()+"&description="+t.getDescription()+"&lieu="+t.getLieu()+"&prix="+t.getPrix()+"&id="+t.getId(); //création de l'URL
        System.out.println(url);
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
