...
//hedhi front
     ...
     */
    function Ajout(Request $req,Request $request, SessionInterface $session,AdresseRepository $adresseRepository,ProduitRepository $produitRepository, CommandeRepository $commandeRepository)
    {
...
//dd($commande);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('affichepaiement');
        }
     ...
     * @return Response
     * @route("/paiement" ,name="affichepaiement")
     */
    function Affichepaiement(CommandeRepository $repository) //meme chose que metre 33 ligne
    {
        //$repo=$this->getDoctrine()->getRepository(ClassroomRepository::class);
        $produit=$repository->findAll();
        return $this->render('produit/paiement.html.twig');
